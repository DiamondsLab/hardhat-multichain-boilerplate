...
var deploy_1 = require("../utils/deploy");
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, deploy_1.deployContract)(hre, "HelloWorlds", [])];
                case 1:
                    res = _a.sent();
                    // Logs the deployment details, including the chain ID and deployed contract address
                    console.log("HelloWorlds on ChainID ".concat(hre.network.config.chainId, " deployed to ").concat(res.address));
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
